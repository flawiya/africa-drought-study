...
# ============================================
ASSET_PATH = 'projects/*************/assets/Southprov_districts_4326'   # CHANGE THIS to your actual asset path
EXPORT_FOLDER = 'southern-province-daily-pet-precip'                      # Google Drive folder
...
for year in years:
    ...
    if count > 0:
        ...
        task = ee.batch.Export.table.toDrive(
            ...
            description=f'DailyPrecipPET_SouthernProvince_{year}',
            folder=EXPORT_FOLDER,
            fileNamePrefix=f'daily_precip_pet_southern_{year}',
            fileFormat='CSV'
        )
        task.start()
