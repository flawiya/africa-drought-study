...
# ============================================
ASSET_PATH = 'projects/vernal-parser-412016/assets/Southprov_districts_4326'   # CHANGE THIS to your actual asset path
EXPORT_FOLDER = 'southern-province-ndvi'                      # Google Drive folder
BANDS = ['NDVI','EVI']
...
# CONFIGURATION – UPDATE THESE
# ============================================
ASSET_PATH = 'projects/**************/assets/Southprov_districts_4326'   # YOUR ACTUAL ASSET
EXPORT_FOLDER = 'southern-province-ndvi'
BANDS = ['NDVI', 'EVI']
...
# ============================================
years = range(2000, 2001)   # 2001 to 2025 (2000 may have partial data)
...
for year in years:
    ...
    if count > 0:
        ...
        task = ee.batch.Export.table.toDrive(
            ...
            description=f'NDVI_Zambia-southern-province_{year}',
            folder=EXPORT_FOLDER,
            fileNamePrefix=f'zambia_{year}',
            fileFormat='CSV'
        )
        task.start()
